...
namespace Repositories
{
    public class StockRepository
    {
        ...
        public List<Stock> ListAllStocks()
        {
            ...
            {
                conn.Open();
                string stockQuery = "Select id, brand, name, cost_price, selling_price, sku, quantity, variation, category_Id from stocks";
        ...
        public Stock FindStock(int id)
        {
            ...
            {
                conn.Open();
                string stockQuery = "Select id, brand, name, cost_price, selling_price, sku, quantity, variation, category_Id from Stocks where id = '" + id + "'";
                MySqlCommand command = new MySqlCommand(stockQuery, conn);
                MySqlDataReader reader = command.ExecuteReader();
                while (reader.Read())
                {
