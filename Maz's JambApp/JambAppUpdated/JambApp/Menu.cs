...
namespace JambApp
{
    public class Menu
    {
        ...
        public static void ShowInfo()
        {
            ...
            if (aspirant == null)
            {
                Console.WriteLine("Student with this registration does`nt exist");
            }
        ...
        public static void InstitutionList()
        {
            ...
            {
                Console.Write($"First Name: {aspirant.FirstName}");
                Console.Write($"Last Name: {aspirant.LastName}");
                Console.Write($"Institution: {aspirant.Institution.Trim()}");
                Console.WriteLine(" ");
            }
