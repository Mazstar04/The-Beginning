...
namespace ScoreRecord
{
    public class Menu
    {
        static string connectionString = "server=localhost;user=root;database=scoremanagement;port=3306;password=419300";
        ...
        private void ContactMenu()
        {
            ...
            Console.WriteLine("6. Overall Best Student");
            Console.WriteLine("7. Total Number of People above Average");
        }
