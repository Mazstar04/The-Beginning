...
namespace StudentRecordKeepingSystem
{
    public class StudentRepository
    {
        ...
        {
            var studentExist = FindStudentByEmail(email);
        ...
        {
            Console.Write("Enter the email of the Student you want to find: ");
        ...
        public void UpdateStudent(string firstName, string email, int age)
        {
            ...
            else
            {
                ...
                student.Age = age;
                Console.WriteLine("Student Information Updated Sucessfully!!");
            }
        }
    }
}